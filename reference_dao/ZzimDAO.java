...
public class ZzimDAO {
	...
	// 찜목록조회
	public List<ContentVO> selectList_zzim(String id) {
		...
		String sql1 = "SELECT d.ref_seq,d.ref_route,d.id, u.nickname, d.title, d.content_price,d.content_main, d.download_cnt, d.content, d.filesize"
				+ " FROM reference_data d, reference_comment c, user_total u, reference_wishlist w" 
				+ " WHERE u.id=d.id AND w.ref_seq = d.ref_seq AND w.id=?"
